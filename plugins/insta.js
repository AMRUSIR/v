...
jsl.addCommand({ pattern: 'insta ?(.*)', fromMe: true, desc:'Downloads post/reel/igtv from instagram',usage:'insta link or reply to a link'}, (async (msg, query) => {
...
jsl.addCommand({ pattern: 'ig ?(.*)', fromMe: true, desc:'Gets account info from instagram',usage:'ig username'}, (async (msg, query) => {
...
jsl.addCommand({ pattern: 'story ?(.*)', fromMe: true, desc:'Downloads full/single story from instagram',usage:'.story username or link'}, (async (msg, query) => {
